<?php
// script pour traiter les résultats du quiz
// Appelé après que l'utilisateur a soumis ses réponses au quiz
// Il calcule le score, la durée du quiz et enregistre les résultats dans la base de données
// Il redirige ensuite l'utilisateur vers la page des résultats du quiz
    session_start();
    ...
    $sql_insert_score = "INSERT INTO scores (user_id, score, duree, categorie, quiz_date) VALUES (?, ?, ?, ?, NOW())";
    ...
    // Redirection vers la page des résultats du quiz
