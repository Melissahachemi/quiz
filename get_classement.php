<?php
// Script pour récupérer le classement des amis et de l'utilisateur connecté
    session_start();
    require_once 'db_connect.php';

    header('Content-Type: application/json'); // Définition du type de contenu de la réponse en JSON
    ...
    // Réponse par défaut si aucun classement n'est trouvé
    $response = [
        'classement' => [],
        'error' => null
    ];
    ...
    // Requête pour récupérer les IDs des amis de l'utilisateur connecté
